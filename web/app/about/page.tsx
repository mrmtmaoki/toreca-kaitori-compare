...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: `${SITE_URL}/about`, siteName: SITE_NAME, locale: "ja_JP", type: "article" },
};
  ...
  return (
    <InfoPage title={title} lead={description}>
      <InfoSection title="サイトの目的">
        <p>
          トレーディングカードを売りたいとき、「どの店舗が一番高く買い取ってくれるか」を調べるには、店舗ごとに1つずつ買取価格ページを見て回る必要があります。{SITE_NAME}
          は、複数の買取店の価格情報を毎日自動で収集し、同じカードの買取価格を1画面で横断比較できるようにした無料サービスです。
        </p>
